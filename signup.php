...
<div class="addSupervisor">
                        <div class="main__form">
                            <div class="main__form--title text-center">Please insert your info</div>
                            <form enctype="multipart/form-data" action="add.php" method="POST" onsubmit="return validateform()">
                                <div class="form-row">
                                    ...
                                    <div class="col col-12">
                                        ...
                                        </label><i>Reason(in pdf format)</i>
                                        <label class="input">
                                            <i id="left" class="fas fa-file"></i>
                                            <input id="pwdinput" type="file" name="file_name" placeholder="reason" required>
